...
var BaseTableDatatables = function() {
    ...
    // Mineral
    var initDataTableMineral = function() {
        jQuery('.js-dataTable-mineral').dataTable({
            processing: true,
            serverSide: true,
            ajax: dt_conf.ajax,
            ...
            "initComplete" : function(){
                ...
                if(dt_conf.bulk) {
                    var target_el = this.attr('id')+'_length';
                    $('#'+target_el).append(dt_conf.bulk);
                }
                
            },
            "rowCallback": dt_conf.rowCallback,
            stateSave: true,
        });
    };
