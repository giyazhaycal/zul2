        ...
        <div class="sidebar-content">
            ...
            <div class="side-header side-content bg-white-op">
                ...
                <div class="btn-group pull-right">
                    <a class="btn btn-link text-gray" href="<?php echo env('WEB_BASE_URL') ?>" title="See website" target="_blank">
                ...
                <a class="h5 text-white" href="#">
                    <!-- <i class="fa fa-circle-o-notch text-primary"></i> --> <span class="h4 font-w600 sidebar-mini-hide"><?php echo config('app.name', 'Laravel'); ?></span>
                </a>
            </div>
            <!-- END Side Header -->
